  ...
  const totalSongs = [
    {
      ...
      artist: "Joakim Karud",
      cover: "./covers/dreams.png",
      duration: "--:--",
      liked: false,
    },
    {
      title: "Clouds",
      src: "./songs/clouds.mp3",
      artist: "Joakim Karud",
      cover: "./covers/clouds.png",
      duration: "--:--",
      liked: false,
    },
    {
      title: "Better Days",
      src: "./songs/better-days.mp3",
      artist: "LAKEY INSPIRED",
      cover: "./covers/better-days.png",
      duration: "--:--",
      liked: false,
    },
    {
      title: "Blue Skies",
      src: "./songs/blue-skies.mp3",
      artist: "Silent Partner",
      cover: "./covers/blue-skies.png",
      duration: "--:--",
      liked: false,
    },
    {
      title: "Good Times",
      src: "./songs/good-times.mp3",
      artist: "Patrick Patrikios",
      cover: "./covers/good-times.png",
      duration: "--:--",
      liked: false,
    },
    {
      title: "Sunny Looks Good on You",
      src: "./songs/sunny-looks-good-on-you.mp3",
      artist: "Midnight North",
      cover: "./covers/sunny-looks-good-on-you.png",
      duration: "--:--",
      liked: false,
    },
  ];
